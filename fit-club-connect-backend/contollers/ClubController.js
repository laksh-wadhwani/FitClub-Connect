...
const SignUpFlow2 = async(request, response) => {
    ...
    const gymProfile = await uploadToCloudinary(request.file.buffer)
...
const UpdateClubDetails = async(request, response) => {
    try {
        ...
        const gymProfileUpdated = uploadToCloudinary(request.file.buffer)
        const lowerCaseCityName = cityName.toLowerCase();
...
const UploadVideo = async(request, response) => {
    const Workout_Video = uploadToCloudinary(request.file.buffer)
